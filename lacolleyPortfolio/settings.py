"""
Django settings for lacolleyPortfolio project.
...
SECRET_KEY = 'buv1@36l!vgtyoafc!-e%xb9_x7t#ah&1j)p+3hh7qflu$z9f0'
...
ROOT_URLCONF = 'lacolleyPortfolio.urls'
...
WSGI_APPLICATION = 'lacolleyPortfolio.wsgi.application'
